 ...
 <header class="header" data-header>
  ...
  <main class="p-5">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center my-5">
        <div class="card shadow p-3 w-50">
            <div class="text-center" id="NewDestination">
                Login
            </div>
            <div class="card-body">
                <form action="{{route('login.login')}}" class="d-flex flex-column" method="POST">
                    @csrf
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Email</label>
                      <input type="text" class="form-control p-2 fs-3 @error('email') is-invalid @enderror" id="exampleInputEmail1" name="email" value="{{old('email')}}">
                      @error('email')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="password" name="password" class="form-control p-2 fs-3 @error('password') is-invalid @enderror" id="exampleInputPassword1" value="{{old('price')}}">
                      @error('password')
                        <p class="text-danger">{{$message}}</p>
                      @enderror
                    </div>
